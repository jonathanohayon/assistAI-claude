  ...
  return (
    <div className="grid w-full max-w-4xl gap-6 lg:grid-cols-[1.1fr_1fr] lg:gap-8">
      ...
      <div className="order-1 lg:order-2">
        ...
        {/* Sign-up rapide Google : form séparé (pas de form imbriqué). Le plan
            coché est transmis via input caché, la locale via cookie côté action. */}
        <form action={startGoogleSignup}>
          <input type="hidden" name="plan" value={selectedKey} />
          <button
            type="submit"
