...
Génère un objet JSON strictement de la forme :
{
  ...
  "for_client": "message WhatsApp à envoyer à la cliente. Chaleureux, en français, signé 'Le salon Prestige'. Inclure le récap du RDV pris ou des actions effectuées. 4-7 lignes max. Pas de markdown.",
  "for_owner": "message WhatsApp à envoyer au propriétaire. Factuel, en français. Liste : prénom cliente / motif / action / RDV (date+heure+prestation) / téléphone si donné. 4-8 lignes. Pas de markdown."
}
...
- Si la cliente a parlé hébreu, garde for_client en hébreu (même structure).
- Adapte for_client à la langue dominante de l'appel.
